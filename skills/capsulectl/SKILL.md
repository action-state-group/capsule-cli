---
name: capsulectl
description: Call the capsulectl verb surface to inspect, validate and record Agent Action Capsules — never to reason about business meaning or invent a workflow beyond the verbs listed below.
---
